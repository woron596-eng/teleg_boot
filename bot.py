...
def post_to_channel():
    ...
    try:
        time.sleep(3)  # Чекаємо, поки webhook налаштується
        ...
        logger.error("❌ Не вдалося опублікувати пост в канал після 3 спроб")
        return False
...
if __name__ == "__main__":
    try:
        ...
        def delayed_post():
            time.sleep(5)  # Чекаємо, поки webhook повністю налаштується
